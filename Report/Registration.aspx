<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/admin.master" AutoEventWireup="true" CodeFile="Registration.aspx.cs" Inherits="Report_Registration" %>
        ...
        <tr>
            <td>
                ...
                <CR:CrystalReportSource ID="CrystalReportSource1" runat="server">
                    <Report FileName="Report\Registration.rpt">
                    </Report>
