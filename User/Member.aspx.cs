...
public partial class User_Member : System.Web.UI.Page
{
    ...
    protected void btnsubmit_Click1(object sender, EventArgs e)
    {
        ...
        {
            cn.Open();
            cmd.CommandText = "insert into Serviceman values("+txtsmanid.Text+",'" + txtfullname.Text + "','" + txtemailid.Text + "','" + txtdob.Text + "',@P1,"+txtmobileno.Text+",'" + txtaddress.Text + "'," + txtpincode.Text + ",'" + txtWSYP.Text + "','" + txtEOWAW.Text + "','" + txtqualification.Text + "','" + Image6.ImageUrl + "','"+txtextraactivity.Text+"')";
