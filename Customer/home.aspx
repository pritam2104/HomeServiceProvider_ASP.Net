    ...
    <div class="ws_images">
        <ul>
            <li class="auto-style17">
                <img src="../data1/images/web_banner_desktop01.jpg" alt="" title="" id="wows1_0"/></li>
            <li><a href="http://wowslider.net">
                <img src="../data1/images/web_banner_desktop02.jpg" alt="jquery slider" title="" id="wows1_1"/></a></li>
            <li>
                <img src="../data1/images/web_banner_desktop03.jpg" alt="" title="" id="wows1_2"/></li>
        </ul>
    </div>
    <div class="ws_bullets">
        <div>
            <a href="#" title=""><span>
            <img src="../data1/tooltips/web_banner_desktop01.jpg" alt=""/>1</span></a> <a href="#" title=""><span>
            <img src="../data1/tooltips/web_banner_desktop02.jpg" alt=""/>2</span></a> <a href="#" title=""><span>
            <img src="../data1/tooltips/web_banner_desktop03.jpg" alt=""/>3</span></a>
        </div>
    </div>
    <div class="ws_script" style="position:absolute;left:-99%">
        <a href="http://wowslider.com">slider</a> by WOWSlider.com v8.7</div>
    <div class="ws_shadow">
    </div>
</div>
